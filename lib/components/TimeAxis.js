...
var TimeAxis = function (_React$Component) {
    ...
    _createClass(TimeAxis, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            if (scaleAsString(this.props.scale) !== scaleAsString(scale) || this.props.utc !== utc || this.props.showGrid !== showGrid || this.props.gridHeight !== gridHeight || this.props.timeZone !== timeZone) {
                this.renderTimeAxis(scale, format, showGrid, gridHeight, timeZone);
            }
        }
        ...
        key: "renderTimeAxis",
        value: function renderTimeAxis(scale, format, showGrid, gridHeight, timeZone) {
            var axis = void 0;
            ...
            if (tickCount > 0) {
                ...
                if (format === "day") {
                    ...
                    axis = (0, _d3Axis.axisBottom)(scale).tickValues(tickValues).tickFormat(function (date) {
                        var timezoneExists = timeZone ? _momentTimezone2.default.tz.zone(timeZone) !== null : false;
                        if (timezoneExists) {
                            return (0, _momentTimezone2.default)(date).tz(timeZone).format(_timeFormat);
                        } else {
                            return (0, _momentTimezone2.default)(date).format(_timeFormat);
                        }
                    }).tickSizeOuter(0);
                }
            } else {
