    ...
    _createClass(LegendItem, [{
        ...
        value: function renderDot(style) {
            ...
            return _react2.default.createElement(
                "svg",
                { style: { float: "left" }, width: symbolWidth, height: symbolHeight },
                _react2.default.createElement("circle", { style: style, cx: w, cy: h, r: radius })
            );
        }
    }, {
        key: "render",
    ...
    _createClass(Legend, [{
        ...
        value: function render() {
            ...
            var _props5 = this.props,
                ...
                legendStyle = _props5.legendStyle;
            ...
            if (this.props.stack) {
                ...
                var mainClassName = this.props.baseStyleClassRoot + "legendComponent " + this.props.legendClassName;

                return _react2.default.createElement(
                    "div",
                    { style: mainStyle, className: mainClassName },
                    items
                );
            } else {
                var _mainStyle = Object.assign({
                    display: "flex",
                    justifyContent: align,
                    flexWrap: "wrap"
                }, legendStyle);
                var _mainClassName = this.props.baseStyleClassRoot + "legendComponent " + this.props.legendClassName;

                return _react2.default.createElement(
                    "div",
                    { style: _mainStyle, className: _mainClassName },
                    items
                );
            }
        }
