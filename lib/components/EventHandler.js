...
var EventHandler = function (_React$Component) {
    ...
    _createClass(EventHandler, [{
        ...
        key: "handleUserInteractionStart",
        value: function handleUserInteractionStart(e) {
        ...
        key: "handleUserInteractionMove",
        value: function handleUserInteractionMove(e) {
            var x = e.pageX;
            var y = e.pageY;
        ...
        key: "handleUserInteractionEnd",
        value: function handleUserInteractionEnd(e) {
        ...
        value: function handleTouchMove(e) {
            ...
            if (touches) {
                ...
                if (touches.length >= 2) {
                    ...
                    var curDiff = Math.abs(touches.item(0).clientX - touches.item(1).clientX);
                    if (this.previousDiff > 0) {
                        ...
                        var xy = this.getOffsetCentralPosition(touches.item(0));
                        var begin = this.props.scale.domain()[0].getTime();
                        var end = this.props.scale.domain()[1].getTime();
                        var center = this.props.scale.invert(xy[0]).getTime();
                        this.triggerZoom(begin, end, center, scale);
