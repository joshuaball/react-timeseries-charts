...
var EventHandler = function (_React$Component) {
    ...
    function EventHandler(props) {
        ...
        _this.handleTouchDone = _this.handleTouchDone.bind(_this);
        return _this;
    }
    ...
    _createClass(EventHandler, [{
        ...
        value: function componentDidMount() {
            ...
            if (this.props.enableDragZoom === true || this.props.enablePanZoom === true) {
                ...
                this.eventHandlerRef.addEventListener("touchstart", this.handleTouchStart, { passive: false });
                this.eventHandlerRef.addEventListener("touchmove", this.handleTouchMove, { passive: false });
                this.eventHandlerRef.addEventListener("touchend", this.handleTouchDone, { passive: false });
                this.eventHandlerRef.addEventListener("touchcancel", this.handleTouchDone, { passive: false });
            }
        }
    }, {
        key: "componentWillUnmount",
        value: function componentWillUnmount() {
            this.eventHandlerRef.removeEventListener("wheel", this.handleScrollWheel, { passive: false });
            this.eventHandlerRef.removeEventListener("touchstart", this.handleTouchStart, { passive: false });
            this.eventHandlerRef.removeEventListener("touchmove", this.handleTouchMove, { passive: false });
            this.eventHandlerRef.removeEventListener("touchend", this.handleTouchDone, { passive: false });
            this.eventHandlerRef.removeEventListener("touchcancel", this.handleTouchDone, { passive: false });
        }

        // get the event mouse position relative to the event rect

    }, {
        key: "getOffsetCentralPosition",
        value: function getOffsetCentralPosition(e) {
        ...
        key: "triggerZoom",
        value: function triggerZoom(begin, end, center, scale) {
        ...
        value: function handleScrollWheel(e) {
            ...
            var xy = this.getOffsetCentralPosition(e);
        ...
        value: function handleMouseDown(e) {
            ...
            if (this.props.enableDragZoom) {
                var offsetxy = this.getOffsetCentralPosition(e);
                this.setState({
                    isDragging: true,
        ...
        value: function handleMouseMove(e) {
            ...
            if (this.state.isPanning) {
                ...
                var mousePosition = this.getOffsetCentralPosition(e);
        ...
        value: function handleTouchMove(e) {
            ...
            if (e.touches && e.touches.length >= 2) {
                ...
                if (this.previousDiff > 0) {
                    ...
                    var xy = this.getOffsetCentralPosition(e.touches.item(0));
                    var begin = this.props.scale.domain()[0].getTime();
                    var end = this.props.scale.domain()[1].getTime();
                    var center = this.props.scale.invert(xy[0]).getTime();
                    this.triggerZoom(begin, end, center, scale);
        ...
        key: "handleTouchDone",
        value: function handleTouchDone(e) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement("div", { style: foreignObjectSizerStyle })
                ),
...
EventHandler.propTypes = {
    ...
    onPinchZoomStart: _propTypes2.default.func,
    onPinchZoomEnd: _propTypes2.default.func,
