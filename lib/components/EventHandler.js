...
var EventHandler = function (_React$Component) {
    ...
    function EventHandler(props) {
        ...
        _this.handlePointerDoneEvent = _this.handlePointerDoneEvent.bind(_this);
    ...
    _createClass(EventHandler, [{
        ...
        value: function handlePointerMove(e) {
            ...
            if (this.eventCache.length === 2) {
                ...
                var curDiff = Math.abs(this.eventCache[0].clientX - this.eventCache[1].clientX);
                if (this.previousDiff > 0) {
                    ...
                    var xy = this.getOffsetCentralPosition(this.eventCache[0]);
                    var begin = this.props.scale.domain()[0].getTime();
                    var end = this.props.scale.domain()[1].getTime();
                    var center = this.props.scale.invert(xy[0]).getTime();
                    this.triggerZoom(begin, end, center, scale);
        ...
        key: "handlePointerDoneEvent",
        value: function handlePointerDoneEvent(e) {
            if (e.persist) {
                e.persist();
            }
            this.removeEvent(e);
