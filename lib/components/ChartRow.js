...
exports.ChartRowCssClass = undefined;
...
var ChartRowCssClass = exports.ChartRowCssClass = "chart-row";
            ...
            _react2.default.Children.forEach(this.props.children, function (child) {
                ...
                if ((0, _reactHotLoader.areComponentsEqual)(child.type, _Brush2.default) || (0, _reactHotLoader.areComponentsEqual)(child.type, _MultiBrush2.default)) {
                    ...
                    if ((0, _reactHotLoader.areComponentsEqual)(child.type, _Brush2.default)) {
                        brushList.push(_react2.default.cloneElement(child, Object.assign(brushProps, {
                            isPinchZooming: _this3.props.isPinchZooming
                        })));
                    } else {
