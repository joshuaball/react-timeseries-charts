...
var TimeMarker = function (_React$Component) {
    ...
    _createClass(TimeMarker, [{
        ...
        value: function renderLine(posx) {
            var lineStyles = _extends({}, this.props.infoStyle.line);
            var classes = lineStyles.classes || "";
            var className = this.props.baseStyleClassRoot + "xTrace__line " + classes;
        ...
        value: function renderTimeMarker(d) {
            ...
            if (this.props.timeFormat === "day") {
                ...
                dateStr = _momentTimezone2.default.duration(+d).format();
                ...
                var _props = this.props,
                    ...
                    _timeFormat = _props.timeFormat;

                var timezoneExists = timeZone ? _momentTimezone2.default.tz.zone(timeZone) !== null : false;
                if (timezoneExists) {
                    dateStr = (0, _momentTimezone2.default)(d).tz(timeZone).format(_timeFormat);
                } else {
                    dateStr = (0, _momentTimezone2.default)(d).format(_timeFormat);
                }
        ...
        value: function renderInfoBox(posx) {
            ...
            var boxClassNames = this.props.infoStyle.box.classes || "";
            var trackerBoxClasses = {
            ...
            var infoBoxProps = {
                align: "left",
                style: {
                    box: _extends({}, this.props.infoStyle.box, trackerBoxClasses),
