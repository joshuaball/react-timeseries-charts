    ...
    _createClass(Baseline, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                style = _props.style,
                width = _props.width,
                baseStyleClassRoot = _props.baseStyleClassRoot;
            ...
            // Style
            //
            var baseLabelStyle = { alignmentBaseline: alignmentBaseline };
            var labelStyle = (0, _merge2.default)(true, baseLabelStyle, style.label ? style.label : {});
            var lineStyle = _extends({}, style.line);
            var labelClasses = baseStyleClassRoot + "baseline__label " + (labelStyle.classes || "");
            var lineClasses = baseStyleClassRoot + "baseline__line " + (lineStyle.classes || "");
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement("polyline", { points: points, style: lineStyle, className: lineClasses }),
